...
public class RelatorioService implements RelatorioUseCases {
    ...
    @Override
    public ComparacaoPropostasResponse gerarRelatorioComparacaoPropostas(PropostasIdsRequest propostasIds) {
        ...
        var relatorioApi = relatoriosClient.gerarRelatorioComparacaoPropostas(propostas.stream()
                ...
                .toList());
        return new ComparacaoPropostasResponse(relatorioApi, propostas);
    }
